...
import { getInterviewPrepModel } from './interview_prep_model';
import { getRecursiveDirectoryModel } from './recursive_directory_model';
import { getEditProfileModel } from './edit_profile_model';
import { getDashboardModel } from './dashboard_model';

export const models = {
    getUpcomingLessonsModel,
    getVoteForLessonsModel,
    getInterviewPrepModel,
