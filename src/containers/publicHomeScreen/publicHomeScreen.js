...
class PublicHomeScreen extends Component {
  ...
  render(){
    ...
    // console.log('lookupUsers', lookupTableAllUsers);
    // console.log('allHomeScreenQuotes', allHomeScreenQuotes)
    // if(allUsers.length > 0 && allHomeScreenQuotes.length > 0){
      ...
      // console.log('userInfoQuoteArray', userInfoQuoteArray)
      // if(userInfoQuoteArray && userInfoQuoteArray.length > 0){
        // let carousel = userInfoQuoteArray.map((user, index) => {
        //   return (
        //     <li key={index}>
        //       <h6>{user.name}</h6>
        //     </li>
