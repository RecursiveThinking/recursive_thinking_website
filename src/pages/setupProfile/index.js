...
import setupProfileHTML from './setupProfile.html'
importTemplate("setupProfile", setupProfileHTML)

export function setup(renderFunction) {
    renderFunction(
        fill(templates.setupProfile.page, getSetupProfileModel())
    );
...
export const getSetupProfileModel = () => {
    ...
    return {
        ...
        setupProfile: fill(templates.setupProfile.currentUserProfile, {
            // basic stats
            ...
            profileSkillProfessional: skillsProfessionalArray.map((skillProfessional, index) => {
                ...
                return fill(templates.setupProfile.currentUserSkillProfessional, {
            ...
            profileSkillSoftware: skillsSoftwareArray.map((skillSoftware) => fill(templates.setupProfile.currentUserSkillSoftware, {
                skillItemSoft: skillSoftware
            })),
            profileSkillLanguage: skillsLanguageArray.map((skillLanguage) => fill(templates.setupProfile.currentUserSkillLanguage, {
